...
export default function Habits() {
  ...
  const categories = [
    { id: "all", label: t("habits.categories.all"), icon: Sparkles },
    { id: "health", label: t("habits.categories.health"), icon: Heart },
    { id: "productivity", label: t("habits.categories.productivity"), icon: Sparkles },
    { id: "mindfulness", label: t("habits.categories.mindfulness"), icon: Brain },
    { id: "fitness", label: t("habits.categories.fitness"), icon: Dumbbell },
    { id: "learning", label: t("habits.categories.learning"), icon: BookOpen },
    { id: "social", label: t("habits.categories.social"), icon: Users },
    { id: "creativity", label: t("habits.categories.creativity"), icon: Palette },
    { id: "general", label: t("habits.categories.general"), icon: Flame },
  ];
  ...
  const fetchHabits = async () => {
    ...
    try {
      ...
      toast({ title: t("common.error"), description: "Failed to load habits", variant: "destructive" });
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="animate-fade-in">
          <Dialog>
            ...
            <DialogContent className="max-w-4xl max-h-[85vh] w-full overflow-y-auto sm:rounded-lg">
              <DialogTitle>{t("habits.guide_dialog_title", "Building Good Habits")}</DialogTitle>
