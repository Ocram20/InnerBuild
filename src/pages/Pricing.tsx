...
export default function Pricing() {
  ...
  const freeFeatures = [
    t("pricing.free_features.habits"),
    t("pricing.free_features.challenges"),
    t("pricing.free_features.tracking"),
    t("pricing.free_features.quotes"),
    t("pricing.free_features.planning"),
    t("pricing.free_features.reflection"),
    t("pricing.free_features.profile"),
    t("pricing.free_features.whats_working"),
    t("pricing.free_features.progress"),
  ];

  const premiumFeatures = [
    t("pricing.premium_features.unlimited_habits"),
    t("pricing.premium_features.unlimited_challenges"),
    t("pricing.premium_features.ai_coach"),
    t("pricing.premium_features.recovery"),
    t("pricing.premium_features.trigger_tracking"),
    t("pricing.premium_features.habit_adaptation"),
    t("pricing.premium_features.learn"),
    t("pricing.premium_features.priority"),
  ];
