...
export default function HabitTips() {
  ...
  return (
    <div className="glass rounded-xl p-4 shadow-card relative animate-fade-in border border-emerald-500/20">
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0 pr-4">
          <p className="text-xs text-emerald-400 font-medium mb-0.5">{t("habit_tips.one_min_tip")}</p>
      ...
      <button onClick={() => setCurrentTip((prev) => (prev + 1) % tipKeys.length)} className="mt-3 flex items-center gap-1 text-xs text-muted-foreground hover:text-emerald-400 transition-colors">
