import { BookOpen, AlertTriangle, Brain, Zap, Users } from "lucide-react";
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-muted-foreground text-sm leading-relaxed">{t("understanding_section.description")}</p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="super-stimulus">
            ...
            <AccordionContent className="text-sm text-muted-foreground space-y-3 pt-2">
              <p>
                {t("understanding_section.super_stimulus_intro_part1")}{" "}
                <strong>{t("understanding_section.super_stimulus_intro_emphasis")}</strong>{" "}
                {t("understanding_section.super_stimulus_intro_part2")}
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>{t("understanding_section.unlimited_novelty_label")}</strong>{" "}
                  {t("understanding_section.unlimited_novelty_desc")}
                </li>
                <li>
                  <strong>{t("understanding_section.instant_access_label")}</strong>{" "}
                  {t("understanding_section.instant_access_desc")}
                </li>
                <li>
                  <strong>{t("understanding_section.extreme_content_label")}</strong>{" "}
                  {t("understanding_section.extreme_content_desc")}
                </li>
              </ul>
              <p>{t("understanding_section.super_stimulus_conclusion")}</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="young-brains">
            ...
            <AccordionContent className="text-sm text-muted-foreground space-y-3 pt-2">
              <p>
                {t("understanding_section.young_brains_intro_part1")}{" "}
                <strong>{t("understanding_section.neuroplasticity")}</strong>{" "}
                {t("understanding_section.young_brains_intro_part2")}
              </p>
              <ul className="list-disc pl-5 space-y-2">
